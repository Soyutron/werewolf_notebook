...
- **`co_seer`**: 占い師としてCOする。
  ...
  - **人狼・狂人**: 嘘の情報を流して場を混乱させたり、本物の占い師の信用を落とす（対抗CO）。

- **`co_villager`**: 村人としてCOする。
  - **村人**: 白いままでいることをアピールする。
  - **人狼・狂人**: 役職COを避けて村人に紛れ込み、疑いを逸らす（潜伏）。あえて占い師COしないという選択も強力な戦略です。
...
**重要**: 狂人や人狼だからといって、必ずしも占い師を騙る必要はありません。「村人CO」や「潜伏」も、村人を誤認させたり、推理を撹乱するための立派な戦略です。状況に応じて柔軟に選択してください。
